...
async function run() {
    try {
        ...
        await repository.football.catalog.refreshCatalogSeasons(catLeague.id);
        ...
        const fixturesResult = await repository.football.fixtures.syncFixtures(LEAGUE_SOURCE_ID, SEASON_YEAR);
