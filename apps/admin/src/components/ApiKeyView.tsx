    ...
    <div className="max-w-3xl space-y-12 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="bg-[#0d1117] border border-slate-800/60 p-10 rounded-2xl shadow-sm">
        ...
        <p className="text-sm text-slate-400 mb-8 leading-relaxed font-normal">
          Provide your API-Football authentication key from <a className="text-sky-400 hover:underline" href="https://dashboard.api-football.com/" target="_blank" rel="noreferrer">dashboard.api-football.com</a>. It is written to the service&apos;s environment and used for all subsequent data fetches.
        </p>

        <div className="bg-slate-900/30 border border-slate-800/60 rounded-lg px-4 py-3 mb-8 flex items-center justify-between">
          <div>
            <div className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest">Current key</div>
            <div className="font-mono text-sm text-slate-300 mt-1">
              {currentKeyMasked ?? <span className="text-slate-500 italic">not set</span>}
            </div>
          </div>
          {currentKeyMasked ? (
