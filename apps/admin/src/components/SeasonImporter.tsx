...
export const SeasonImporter: React.FC<SeasonImporterProps> = ({
    ...
    return (
        <section className="bg-[#0d1117] border border-slate-800/60 p-10 rounded-2xl shadow-sm space-y-8 relative overflow-hidden isolate group/box2 transition-all hover:border-slate-800">
