...
<ultra-vs profile-a="streamer1" profile-b="streamer2" show-fixtures="true" theme="dark"></ultra-vs>
```
...
```html
<!-- Show top predictors -->
<ultra-leaderboard league="efl-championship" limit="10" theme="dark"></ultra-leaderboard>
```
